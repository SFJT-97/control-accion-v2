...
import { useGetFile } from './storedFilesQH'
...
export const useMe = () => {
  ...
  if (meData) {
    ...
    //   //   console.log('entró')
    //   //   try {
    //   //     console.log('_______________________data.me.userProfileImage=', data.me.userProfileImage)
    //   //     const resultemp = useGetFile(data.me.userProfileImage)
    //   //     console.log('resultemp\n', resultemp)
    //   //     tempURL = resultemp
    //   //     console.log('________________________________________tempURL\n', tempURL)
    //   //   } catch (error) { }
    //   // }
    // }, [data])
